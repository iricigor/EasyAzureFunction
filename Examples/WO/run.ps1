...
try {
  ...
  $EzNoEnumerate = $requestBody.EzNoEnumerate
} catch {$Failed = $true}
if ($Failed) {
...
if (!$EzInvokeCommand) {
  ...
  $Head = "<head><style>body {background-color: #012456; color: $Color;}</style><title>EasyAzureFunction - Write-Output running example</title></head>"
